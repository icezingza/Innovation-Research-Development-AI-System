...
print("Tenant ID: a0000000-0000-0000-0000-000000000001")
...
with TestClient(app) as client:
    ...
    print("\n[Test 3] GET /tenants/a0000000-0000-0000-0000-000000000001/finops")
    response = client.get(
        "/tenants/a0000000-0000-0000-0000-000000000001/finops", headers=headers
    )
    print(f"Status: {response.status_code}")
    if response.status_code == 200:
        data = response.json()
    ...
    print(f"Status: {response.status_code}")
    if response.status_code != 200:
        print("Response (Expected 401): OK")
