...
def upgrade() -> None:
    ...
    op.create_table('hypothesis_records',
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['tenant_id'], ['tenants.id'], name=op.f('api_keys_tenant_id_fkey')),
    ...
    sa.ForeignKeyConstraint(['tenant_id'], ['tenants.id'], name=op.f('projects_tenant_id_fkey')),
    ...
    sa.Column('payment_method', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True),
    ...
    sa.Column('units_consumed', sa.BIGINT(), server_default=sa.text("'0'::bigint"), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('tenant_id', 'date', 'metric_name', name=op.f('tenant_usage_pkey'))
    )
