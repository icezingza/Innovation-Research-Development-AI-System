...
async def test_advanced_semantic_with_filtering(qdrant_db):
    ...
    fragments = [
        {
            "id": 1,
            "text": "Empathy Engine: การรับรู้อารมณ์ผ่านน้ำเสียง",
            "topic": "empathy",
            "confidence": 0.95,
        },
        {
            "id": 2,
            "text": "Inference Router: การเลือกโมเดลตามความยากของงาน",
            "topic": "infra",
            "confidence": 0.88,
        },
        {
            "id": 3,
            "text": "Empathy Engine: การปรับโทนเสียงให้เข้ากับผู้ใช้",
            "topic": "empathy",
            "confidence": 0.70,
        },
    ]
        ...
        query_filter=models.Filter(
            must=[
                models.FieldCondition(
                    key="topic", match=models.MatchValue(value="empathy")
                ),
